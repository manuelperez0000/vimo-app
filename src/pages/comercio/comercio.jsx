                ...
                <div className="col-6 offset-3 p-4 chat-c">
                    <div className='mb-3'>
                        <div className='principal-msg' >
                            {deposit?.agent ? <> <div className="d-flex gap-4">
                                <PerfilImage />
                                <div>
                                    <div className="">
                                        {deposit.agent.name}
                                ...
                                <div>Esperando por un comerciante verificado</div>
                            </div>}
                        </div>
                    </div>
                    {deposit?.chat?.length > 0 ? deposit.chat.map((item, i) => {
